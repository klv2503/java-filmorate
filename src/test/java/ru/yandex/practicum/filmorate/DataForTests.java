...
public class DataForTests {
    ...
    public static void generateFilms(FilmController filmController) {
        filmController.create(
                new Film("TestName1", "TestDescr1", LocalDate.of(2000, 10, 10), 100L));
        filmController.create(
                new Film("TestName2", "TestDescr2", LocalDate.of(2010, 5, 5), 120L));
        filmController.create(
                new Film("TestName3", "TestDescr3", LocalDate.of(2005, 3, 25), 80L));
        filmController.create(
                new Film("TestName4", "TestDescr4", LocalDate.of(1998, 8, 31), 70L));
    }
